      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <span className="px-3 py-1.5 rounded-lg text-[10px] font-black border uppercase tracking-tighter bg-brand-gold/10 text-brand-gold border-brand-gold/20">
              {order.paymentStatus}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-gray-50/30 flex justify-end">
              <div className="w-64 flex flex-col gap-4">
                ...
                <div className="flex justify-between text-xl font-black text-gray-900">
                  ...
                  <span className="text-brand-gold">{order.totals.grandTotal}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white p-8 border border-[#1C1C1C1A] rounded-[6px] flex flex-col gap-6">
            ...
            <Button variant="ghost" className="w-full text-brand-gold font-black hover:bg-brand-gold/10 py-3 rounded-xl transition-all" shape="rounded-sm">
              View Full Profile
            </Button>
          </div>
