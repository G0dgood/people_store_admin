...
import { MediaSkeleton as GiftBoxSkeleton } from "@/app/components/Admin/MediaSkeleton";
...
const GiftBoxesPage = () => {
 ...
 const { data: response, isLoading, refetch, isFetching } = useGetGiftBoxesQuery({
  search,
  ...
  <div className="flex flex-col gap-6 max-w-[1600px] mx-auto pb-12">
   ...
   <div className="flex justify-between items-end">
    ...
    <div className="flex gap-3">
     <Tooltip text="Refresh Gift Boxes">
   ...
   <div className="bg-white rounded-[6px] border border-gray-200   overflow-hidden flex flex-col">
    ...
    <div className="p-6 min-h-[400px] flex flex-col">
     {(isLoading || isFetching) ? (
      <GiftBoxSkeleton viewType={viewType} count={8} />
     ) : giftBoxes.length === 0 ? (
        ...
        <tbody className="divide-y divide-gray-50">
         {paginatedBoxes.map((box) => (
          <tr key={box._id} >
           ...
           <td>{box.products?.length || 0} Products</td>
           <td>₦{box.price.toLocaleString()}</td>
           <td>
