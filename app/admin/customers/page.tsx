...
import { HiUser, HiLockClosed, HiLockOpen } from "react-icons/hi2";
...
export default function CustomersListing() {
  ...
  const { data: statsResponse, isLoading: isLoadingStats } = useGetCustomerStatsQuery();
      ...
      <div className="flex flex-col xl:flex-row gap-4">
        <div className="flex flex-col gap-3 w-full xl:w-[280px]">
          <StatCard
            ...
            value={isLoadingStats ? "..." : stats?.totalCustomers || "0"}
            trendValue="14.4%"
            trendIsUp={true}
          />
          <StatCard title="Visitor" value={isLoadingStats ? "..." : stats?.visitorCount || "0"} trendValue="20%" trendIsUp={true} />
        </div>
