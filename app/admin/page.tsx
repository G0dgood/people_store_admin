        ...
        <div className="xl:col-span-8 flex flex-col gap-6">
          ...
          <div className="bg-white p-8 rounded-[6px] border border-gray-100 shadow-sm flex flex-col gap-6">
            <div className="flex justify-between items-center">
              ...
              <Button className="bg-[#66BB6A] hover:bg-[#4CAF50] text-white text-[11px] font-black px-6 h-9 rounded-[6px] flex items-center gap-2 shadow-sm">
                 Filter <Icon name="sort" folder="dashboardIcon" size="xs" />
              </Button>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="text-[11px] font-black text-gray-500 border-b border-gray-100">
                    <th className="pb-4 font-black">No</th>
                    <th className="pb-4 font-black">Id Customer</th>
                    <th className="pb-4 font-black">Order Date</th>
                    <th className="pb-4 font-black pl-4">Status</th>
                ...
                <tbody className="divide-y divide-gray-50/50">
                  {[
                    ...
                    <tr key={i} className="group">
                      <td className="py-5 text-[13px] font-black text-[#1D3557]">{i + 1}.</td>
                      <td className="py-5 text-[13px] font-black text-[#1D3557]">#{tx.id}</td>
                      <td className="py-5 text-[11px] font-bold text-gray-600">{tx.date}</td>
                      ...
                      <td className="py-5 text-[13px] font-black text-[#1D3557] text-right">{tx.amount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="flex justify-end pt-2">
               <Button variant="ghost" className="border border-brand-blue/20 text-brand-blue text-[10px] font-black uppercase tracking-widest px-8 h-10 rounded-[6px] hover:bg-brand-blue/5">
                 Details
               </Button>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-[6px] border border-gray-100 shadow-sm flex flex-col gap-6">
             ...
             <div className="overflow-x-auto">
               <table className="w-full text-left">
                 <thead>
                   <tr className="text-[10px] font-black text-[#2E7D32] uppercase tracking-widest bg-[#E9F4E9]">
                     <th className="p-4 rounded-l-[6px]">PRODUCT</th>
                     <th className="p-4">TOTAL ORDER</th>
                     <th className="p-4">STATUS</th>
                     <th className="p-4 rounded-r-[6px] text-right">PRICE</th>
                   </tr>
                 </thead>
                 <tbody className="divide-y divide-gray-50/50">
                   {[
                     { name: "Apple iPhone 13", orders: 104, status: "Stock", price: "₦999.00", image: "/dashboardImage/Frame 4259.png", color: "bg-[#4CAF50]" },
                     { name: "Nike Air Jordan", orders: 56, status: "Stock out", price: "₦999.00", image: "/dashboardImage/Frame 4259 copy.png", color: "bg-red-500" },
                     { name: "T-shirt", orders: 266, status: "Stock", price: "₦999.00", image: "/dashboardImage/Frame 4259 copy 2.png", color: "bg-[#4CAF50]" },
                     { name: "Cross Bag", orders: 506, status: "Stock", price: "₦999.00", image: "/dashboardImage/Frame 4259 copy 3.png", color: "bg-[#4CAF50]" },
                   ].map((p, i) => (
                     <tr key={i} className="group">
                        <td className="p-4 flex items-center gap-4">
                           <img src={p.image} className="w-10 h-10 rounded-[6px] object-contain bg-gray-50 border border-gray-100 p-1" />
                           <span className="text-[12px] font-black text-[#1D3557]">{p.name}</span>
                        </td>
                        <td className="p-4 text-[12px] font-bold text-gray-500">{p.orders}</td>
                        <td className="p-4">
                           <div className="flex items-center gap-2">
                        ...
                        <td className="p-4 text-[12px] font-black text-[#1D3557] text-right">{p.price}</td>
                     </tr>
                   ))}
                 </tbody>
               </table>
             ...
             <div className="flex flex-col gap-6 pt-6 border-t border-gray-100 mt-2">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between">
                     ...
                     <button className="flex items-center gap-1.5 px-4 py-1.5 rounded-[6px] bg-[#E9F4E9] text-[#2E7D32] text-[10px] font-black uppercase hover:bg-[#2E7D32] hover:text-white transition-all shadow-sm">
