...
import { useGetProductsQuery, useDeleteProductMutation, Product } from "@/lib/redux/services/productApi";
      ...
      <tbody>
       {isLoading ? (
        ...
        <tr key={product._id} className="group">
         ...
         <td>
          <span className={`px-3 py-1.5 rounded-[6px] text-[10px] font-bold ${statusStyles[product.status as keyof typeof statusStyles] || statusStyles.Draft}`}>
           {product.status}
          </span>
         </td>
