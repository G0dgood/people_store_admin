    ...
    <div className="min-h-screen !bg-white flex flex-col font-sans text-black">
      ...
      <main className="flex-1 w-full bg-white py-8 md:py-12">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 flex flex-col gap-12 md:gap-24">
            ...
            <div className="px-6 md:px-10 lg:px-16 relative z-10">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-brand-gold font-bold tracking-[0.3em] text-xs">Global Logistics</span>
                </div>
                <h1 className="text-4xl md:text-7xl font-black text-black tracking-tighter font-inter leading-none">
                  Delivering Excellence <br />to Your <span className="text-brand-gold">Doorstep.</span>
                </h1>
                <p className="text-gray-500 max-w-2xl text-base md:text-xl leading-relaxed font-medium">
          ...
          {/* Shipping Methods and Timeline grid */}
          <section className="">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {methods.map((method, i) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-black mb-4">{method.title}</h3>
                  <div className="flex flex-col gap-1 mb-6">
                    <div className="flex items-center gap-2 text-brand-gold">
                      <HiClock />
                      <span className="text-sm font-bold tracking-widest">{method.time}</span>
                    </div>
                    <span className="text-xs text-gray-500 font-medium">{method.cost}</span>
                  </div>
            ...
            <div className="mt-20 flex flex-col lg:flex-row gap-12 items-center bg-gray-50 rounded-[40px] p-10 md:p-16 border border-gray-200">
              <div className="flex-1 flex flex-col gap-6">
                <h2 className="text-3xl font-black text-black tracking-tight">Regional Estimates</h2>
                ...
                <div className="grid grid-cols-2 gap-6">
                  {regionalEstimates.map((region, i) => (
                    <div key={i} className="flex flex-col gap-1">
                      <span className="text-[10px] font-bold text-gray-400 tracking-widest">{region.region}</span>
                      <span className="font-black text-black text-xl">{region.days}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {/* Tracking Journey and Packaging commitments */}
          <section className="bg-black py-24 md:py-32 relative overflow-hidden rounded-[24px] md:rounded-[48px]">
            <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
              <div className="flex flex-col gap-10">
                <div className="flex flex-col gap-4">
                  <span className="text-brand-gold font-bold tracking-[0.2em] text-xs">Stay Connected</span>
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed">Receive SMS and Email updates the moment your package reaches a new milestone.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-6">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-gold shrink-0">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed">All products are shipped in eco-friendly, reinforced Bloom & Mist packaging for maximum protection.</p>
                    </div>
                  </div>
                </div>

                <div className="pt-4">
                  <button className="bg-brand-gold text-white px-12 py-5 rounded-2xl font-black tracking-widest text-sm shadow-2xl shadow-black/20 hover:scale-105 transition-all">
                    Track My Order
                  </button>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative rounded-[40px] overflow-hidden border border-white/10 aspect-video shadow-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
                    <div className="flex flex-col gap-1">
                      <span className="text-[10px] font-black tracking-widest text-brand-gold">Real-time Dashboard</span>
          ...
          <section className="py-24 md:py-32 bg-white">
            <div className="max-w-[1440px] mx-auto px-6 text-center">
              <h2 className="text-3xl font-black text-black mb-6 tracking-tight">Still have shipping questions?</h2>
              ...
              <button
                ...
                className="px-10 py-4 bg-gray-50 border border-gray-200 rounded-xl text-black font-black tracking-widest text-xs hover:bg-white hover:border-brand-gold hover:text-brand-gold transition-all"
              >
                Visit Help Center
              </button>
            </div>
