...
export default function OrderDetailsPage() {
 ...
 const handleHomeDeliverySave = (details: any, paymentType: string) => {
      ...
      <div>
       ...
       <div className="flex gap-4">
        <button
         ...
         className={`flex h-[48px] w-[160px] items-center justify-center rounded-[8px] font-work text-sm transition-all ${deliveryMethod === "pickup"
        ...
        <button
         ...
         className={`flex h-[48px] w-[160px] items-center justify-center rounded-[8px] font-work text-sm transition-all ${deliveryMethod === "home"
           ? "bg-[#156BB6] text-white"
           : "border border-[#F4F4F4] bg-[#FAFAFA] text-[#808080] hover:bg-gray-50"
          }`}
        >
