...
import { SectionHeaderSimple } from "../components/ui/SectionHeaderSimple";
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex items-end gap-3 mb-6">
              ...
              />
              <span className="text-sm md:text-lg text-gray-400 font-outfit mb-1">
              ...
              <div className="flex-1 bg-white flex flex-col w-full">
                {cartItems?.length > 0 ? (
                  ...
                  <Icon name="shopping_cart" size="md" />
                    ...
                    <div className="flex flex-col gap-3">
                      <p className="text-xl md:text-2xl font-outfit font-light text-gray-900  tracking-widest">Your cart is <span className="font-bold">empty</span></p>
                      <p className="text-gray-500 text-xs  tracking-wider font-medium">Looks like you haven't added anything to your cart yet.</p>
                    </div>
                    {/* <Link href="/products">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-10 mt-auto">
                  <Link href="/products" className="w-full md:w-auto order-2 md:order-1">
                    <Button
                      className="w-full md:w-fit text-black border border-black px-10 h-12 font-bold  tracking-widest text-[10px] hover:bg-black hover:text-white transition-all rounded-none"
                  ...
                  {cartItems.length > 0 && (
                    <Button
                      ...
                      className="w-full md:w-auto order-1 md:order-2 text-red-500 bg-red-400 border border-red-400 px-8 h-12 font-bold  tracking-widest text-[10px] hover:bg-red-600 transition-all rounded-none"
                    >
                      Clear All Items
                    </Button>
                  )}
