...
export const StockWarning: React.FC<StockWarningProps & { isUnlimited?: boolean }> = ({
  ...
  if (isUnlimited) {
    return (
      <div className={`flex items-center gap-1.5 ${className}`}>
        ...
        <span className="text-[9px] font-bold tracking-widest text-gray-400 whitespace-nowrap">
          Always Available
        </span>
      </div>
    );
  ...
  if (stock > 0) {
    ...
    return (
      <div className={`whitespace-nowrap flex items-center gap-1.5 ${className}`}>
        ...
        <span className={`text-[9px] font-bold tracking-widest ${colorClass}`}>
  ...
  return (
    <div className={`flex items-center gap-1.5 ${className}`}>
      ...
      <span className="text-[9px] font-bold tracking-widest text-rose-500 whitespace-nowrap">
        Out of Stock
      </span>
    </div>
  );
