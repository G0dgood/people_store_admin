...
const CartItem: React.FC<CartItemProps> = ({ title, price, image, meta }) => {
  return (
    <div className="flex flex-col md:flex-row gap-4 py-6 border-b border-gray-100 last:border-0">
      ...
      <div className="flex-1 flex flex-col gap-1.5">
         ...
         <div className="flex items-center gap-4 mt-2">
            <Button variant="ghost" className="!text-[#EB001B] text-xs font-bold px-3 py-1.5 border border-gray-200 hover:bg-red-50 shadow-none h-auto">
               Remove
            </Button>
            <Button variant="ghost" className="text-brand-blue text-xs font-bold px-3 py-1.5 border border-gray-200 hover:bg-blue-50 shadow-none h-auto">
               Save for later
            </Button>
         </div>
      </div>
