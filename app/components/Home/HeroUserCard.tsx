    ...
    <div className="hidden md:flex w-full xl:w-64 flex-col gap-2.5 px-4 pb-4 md:p-0">
      ...
      <div className="bg-[#E3F0FF] p-5 rounded-lg flex md:flex-col gap-3 items-center md:items-start shadow-sm">
        ...
        <div className="flex-1 w-full flex flex-col gap-2">
          ...
          <Button onClick={openLogin} variant="ghost" size="sm" className="w-full bg-white text-brand-blue border-none shadow-sm hover:bg-gray-50 transition-colors cursor-pointer">Log in</Button>
        </div>
      </div>
