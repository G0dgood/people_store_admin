                ...
                return (
                  <button
                    ...
                    className={`group relative aspect-[16/10] rounded-[4px] overflow-hidden border-4 transition-all
                          ${isSelected ? "border-brand-gold ring-8 ring-brand-gold/10 scale-[1.02]" : "border-transparent opacity-70 hover:opacity-100  "}
                        `}
                  >
                ...
                return (
                  <button
                    ...
                    className={`group relative aspect-square rounded-[4px] overflow-hidden border-2 transition-all p-2 flex flex-col gap-2
                          ${isSelected ? "border-brand-gold bg-brand-gold/5 ring-4 ring-brand-gold/10" : "border-gray-200 bg-white hover:border-brand-gold/30  "}
                        `}
                  >
              ...
              <div className="w-full flex flex-col gap-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {config.backgroundImages.filter(bg => bg.url.startsWith("http")).map((asset, i) => (
                    <div key={i} className="relative aspect-[16/6] rounded-[6px] overflow-hidden border border-gray-200   group">
            ...
            <div className="flex flex-col gap-8 items-center justify-center py-10 px-6">
              <div
                className={`w-full h-full border-2 border-dashed rounded-[12px] p-10 flex flex-col items-center justify-center gap-4 transition-all
                    ...
                    : "border-gray-200 bg-transparent hover:border-brand-gold hover:bg-brand-gold/5  "}
                  `}
              ...
              >
                ...
                />
                <div className="w-16 h-16 rounded-full bg-white   flex items-center justify-center text-gray-400 group-hover:text-brand-gold transition-all">
