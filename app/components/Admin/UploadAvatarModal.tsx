            ...
            <div className={`w-40 h-40 rounded-full border-2 border-dashed flex flex-col items-center justify-center gap-3 transition-all overflow-hidden ${
              ...
              : "border-gray-200 bg-gray-50/50 hover:bg-white hover:border-brand-gold/30"
                ...
                {previewUrl ? (
                  ...
                  <>
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-gray-400 group-hover:text-brand-gold group-hover:scale-110 transition-all shadow-sm">
