  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Update Profile Photo" size="md">
      <ModalBody className="flex flex-col items-center gap-8 py-10">
        ...
        >
          <div className={`w-40 h-40 rounded-full border-2 border-dashed flex flex-col items-center justify-center gap-3 transition-all overflow-hidden ${previewUrl
              ? "border-brand-gold/50 bg-white"
              : "border-gray-200 bg-gray-50/50 hover:bg-white hover:border-brand-gold/30"
            ...
            {previewUrl ? (
              ...
              <>
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-gray-400 group-hover:text-brand-gold group-hover:scale-110 transition-all  ">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
            <div className="absolute top-0 left-0 w-4 h-4 border-l-2 border-t-2 border-brand-gold rounded-tl-lg"></div>
            <div className="absolute top-0 right-0 w-4 h-4 border-r-2 border-t-2 border-brand-gold rounded-tr-lg"></div>
            <div className="absolute bottom-0 left-0 w-4 h-4 border-l-2 border-b-2 border-brand-gold rounded-bl-lg"></div>
            <div className="absolute bottom-0 right-0 w-4 h-4 border-r-2 border-b-2 border-brand-gold rounded-br-lg"></div>
          </div>
        </div>
