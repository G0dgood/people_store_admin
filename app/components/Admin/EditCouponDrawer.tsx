     ...
     <div className="flex flex-col gap-3">
      ...
      {formData.image ? (
       <div className="flex flex-col gap-4">
        <div
         className={`relative w-full h-48 rounded-xl overflow-hidden border border-gray-100 shadow-sm group bg-gray-100 ${formData.mediaType !== "video" ? `cursor-${isDragging ? 'grabbing' : 'grab'}` : 'cursor-pointer'}`}
        ...
        >
         ...
         {formData.mediaType !== "video" && (
          <div className="absolute top-3 right-3 px-2 py-1 bg-white/90 backdrop-blur-sm rounded text-[8px] font-black uppercase tracking-tighter text-gray-500 shadow-sm pointer-events-none">
         ...
         <div className="flex flex-col gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <div className="flex flex-col gap-2">
           <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-black text-brand-gold bg-white px-2 py-0.5 rounded shadow-sm border border-gray-100">
             {currentCoords.y}%
            </span>
           </div>
           <input
