    ...
    >
      <DropdownMenu width={320} className="shadow-2xl border-gray-200 p-0">
        <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center bg-gray-50/50">
          ...
          <span className="text-[10px] text-brand-gold bg-brand-gold-light px-2 py-0.5 rounded-full font-bold">2 New</span>
        </div>
        ...
        <div className="flex flex-col max-h-[320px] overflow-y-auto">
          ...
          <div className="px-4 py-3 hover:bg-gray-50 flex gap-3 cursor-pointer transition-colors border-b border-gray-50 last:border-0 opacity-75">
            <div className="w-10 h-10 rounded-full bg-brand-gold-light flex items-center justify-center flex-shrink-0 text-brand-gold shadow-inner">
