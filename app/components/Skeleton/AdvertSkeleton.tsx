      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-12 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 bg-white p-8 rounded-[6px] border border-gray-100 shadow-sm">
            ...
            <div className="bg-white p-8 rounded-[6px] border border-gray-100 shadow-sm">
              <div className="h-7 w-48 bg-gray-200 rounded-[4px] mb-8" />
