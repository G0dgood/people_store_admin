...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      outline: "bg-white text-black border border-gray-200 hover:bg-brand-gold hover:text-white hover:border-brand-gold active:scale-[0.98] focus:ring-brand-gold/50 transition-all duration-300",
