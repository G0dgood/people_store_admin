...
import { ViewProductModal } from "@/app/components/Admin/ViewProductModal";
import { BulkActionsDrawer } from "@/app/components/Admin/BulkActionsDrawer";
import { BulkAssignLocationModal } from "@/app/components/Admin/BulkAssignLocationModal";
import { ProductInventoryModal } from "@/app/components/Admin/ProductInventoryModal";
...
import { StockWarning } from "@/app/components/StockWarning";
...
export default function ProductListing() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [activeTab, selectedCategory, selectedBrand, searchQuery, rowsPerPage]);
    ...
    <div className="flex flex-col gap-6 max-w-[1600px] mx-auto pb-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-2">
        <div className="bg-white p-6 rounded-[6px] border border-gray-200 flex items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-2xl font-black text-[#121212]">{products.length}</span>
          </div>
          <div className="p-3 bg-gray-50 rounded-[6px] text-brand-gold">
      ...
      <div className="bg-white overflow-hidden flex flex-col border border-[#1C1C1C1A] rounded-[6px]">
        ...
        <div className="p-4 sm:p-6 flex flex-col lg:flex-row gap-6 items-center justify-between border-b border-gray-50">
          <div className="flex flex-col lg:flex-row items-center gap-4 w-full lg:flex-1">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr key={product._id} className="group">
                  ...
                  <td>
                    <span className="text-xs font-bold text-brand-gold bg-brand-gold/5 px-2 py-1 rounded-[4px] whitespace-nowrap">
                  ...
                  <td className="text-right">
                    <div className="flex justify-end items-center gap-2">
                      <Tooltip text="View Details" position="top">
                        <Button shape="rounded-sm" variant="outline"
                          className="!p-1.5 text-gray-400 hover:text-white hover:bg-brand-gold hover:border-blue-500 transition-all"
                          onClick={() => {
                      ...
                      <Tooltip text="Duplicate as Draft" position="top">
                        <Button shape="rounded-sm" variant="outline"
                          className="!p-1.5 text-gray-400 hover:text-brand-gold hover:bg-gray-50 hover:border-blue-100 transition-all"
