    ...
    <main className="min-h-screen bg-[#F8FAFC] py-12 md:py-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-[32px] shadow-xl shadow-brand-blue/5 overflow-hidden border border-gray-100"
        >
          <div className="p-8 md:p-12">
                ...
                {order?.items.map((item: any, idx: number) => (
                  <div key={idx} className="flex items-center gap-4 group">
                    ...
                    <div className="flex-grow">
                      <h4 className="text-sm font-bold text-gray-900 group-hover:text-brand-blue transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/orders"
                className="flex-grow bg-white text-gray-900 border-2 border-gray-200 hover:border-brand-blue hover:text-brand-blue h-14 rounded-2xl flex items-center justify-center font-black transition-all active:scale-[0.98]"
              >
                View My Orders
              </Link>
              <Link
                href="/products"
                className="flex-grow bg-brand-blue text-white shadow-lg shadow-brand-blue/20 hover:shadow-brand-blue/40 h-14 rounded-2xl flex items-center justify-center font-black transition-all hover:translate-y-[-2px] active:scale-[0.98]"
              >
                Continue Shopping
              </Link>
            </div>
        ...
        <p className="text-center mt-12 text-gray-500 text-sm font-medium">
          ...
          <a href="mailto:support@bloomandmist.com" className="text-brand-blue font-bold">
