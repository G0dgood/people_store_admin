            ...
            <main className="flex-1 w-full bg-white">
                ...
                <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 bg-[#1D3557] overflow-hidden">
                    ...
                    <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 relative z-10">
                        ...
                        >
                            <span className="text-[#8CB7F5] font-black tracking-[0.4em] uppercase text-xs">Privacy Orchestration</span>
                            <h1 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none font-inter">
                                Cookie <br /><span className="text-[#8CB7F5]">Preferences.</span>
                            </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-10">
                            <div className="flex flex-col gap-6">
                                <h2 className="text-3xl md:text-5xl font-black text-[#1D3557] tracking-tight">Our Integrity.</h2>
                        ...
                        <div className="lg:col-span-7 bg-white border border-gray-200 rounded-[48px]   overflow-hidden">
                                    ...
                                    <div key={cookie.id} className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-10 border-b border-gray-50 last:border-0 last:pb-0">
                                        <div className="flex items-start gap-6 flex-1">
                                            ...
                                            <div className="flex flex-col gap-1">
                                                <h4 className="font-black text-[#1D3557] uppercase tracking-tighter">{cookie.title}</h4>
                            ...
                            <div className="bg-gray-100/50 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-gray-200">
                                ...
                                <div className="flex gap-4 w-full md:w-auto">
                                    ...
                                    <Button variant="primary" className="flex-1 md:flex-none bg-[#1D3557] text-white px-10 h-14 font-black uppercase tracking-widest text-sm">
                                        Accept All
                                    </Button>
                                </div>
                            </div>
