    ...
    <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 flex flex-col gap-12 md:gap-24">
     ...
     <section className="relative pt-10 pb-12 md:pb-20 bg-white overflow-hidden">
      ...
      <div className=" relative z-10">
       ...
       >
        <span className="text-brand-gold font-black tracking-[0.4em] text-xs">Security Framework</span>
        <h1 className="text-4xl md:text-7xl font-black text-black tracking-tighter leading-none font-inter">
         Secure <br /><span className="text-brand-gold">Orchestration.</span>
        </h1>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
        <div className="flex flex-col gap-8">
         <div className="flex flex-col gap-4">
          <span className="text-brand-gold font-bold tracking-[0.2em] text-xs">Technical Integrity</span>
          <h2 className="text-3xl md:text-5xl font-black text-black tracking-tight leading-tight">Artisanal Encryption <br />Standards.</h2>
         </div>
         ...
         <div className="flex flex-wrap gap-6 pt-4">
          <div className="flex items-center gap-3 text-black">
           ...
           <span className="text-xs font-black tracking-widest">SSL Secure</span>
          </div>
          <div className="flex items-center gap-3 text-black">
           <HiCheckBadge className="text-brand-gold" size={24} />
           <span className="text-xs font-black tracking-widest">PCI Compliant</span>
          </div>
         </div>
        </div>

        <div className="flex flex-col gap-8 bg-black p-10 md:p-12 rounded-[48px] shadow-2xl relative overflow-hidden group">
         ...
         <div className="flex items-center gap-4 text-brand-gold relative z-10">
         ...
         <div className="flex items-center gap-3 relative z-10">
          ...
          <div className="flex flex-col">
           <span className="text-[10px] font-black text-brand-gold tracking-widest">Chief Security Officer</span>
