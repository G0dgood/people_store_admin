...
import { HiCheckCircle, HiMagnifyingGlass, HiCubeTransparent, HiTruck } from "react-icons/hi2";
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 flex flex-col gap-12 md:gap-24">
          ...
          <section className="relative pt-10 pb-12   md:pb-20 bg-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              >
                <span className="text-brand-gold font-black tracking-[0.4em] text-xs">Real-time Logistics</span>
                <h1 className="text-5xl md:text-7xl font-black text-black tracking-tighter leading-none font-inter">
                  Follow Your <br /><span className="text-brand-gold">Journey.</span>
                </h1>
          ...
          <section className="">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 xl:gap-24 items-start">
              ...
              <div className="lg:col-span-4 flex flex-col gap-10">
                <form onSubmit={handleTrack} className="flex flex-col gap-8 bg-gray-50 border border-gray-200 p-8 rounded-[6px]  ">
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-black tracking-widest text-black opacity-60">Order ID</label>
                    <Input
                      type="text"
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-black tracking-widest text-black opacity-60">Account Email</label>
                    <Input
                      type="email"
                  ...
                  <Button
                    type="submit"
                    variant="primary"
                    className="w-full h-14 bg-brand-gold text-white font-black tracking-widest text-sm shadow-xl shadow-black/10"
                  >
                    Visualize Journey
                  </Button>
                  ...
                  <button
                    ...
                    className="text-[10px] font-black tracking-[0.2em] text-brand-gold/60 hover:text-brand-gold transition-colors text-center w-full"
                  >
                    Try with Demo ID
                  </button>
                </form>

                <div className="flex flex-col gap-6 text-sm text-gray-500 bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-200 pb-10">
                        <div className="flex flex-col gap-1">
                          <h3 className="text-3xl font-black text-black tracking-tight">Status: Shipped</h3>
                          <p className="text-gray-500 font-medium">Estimated arrival: <span className="text-brand-gold">October 28, 2026</span></p>
                        </div>
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex flex-col">
                            <span className="text-[10px] font-black text-gray-400 tracking-widest">Courier</span>
                            <span className="font-bold text-black">Global Express</span>
                          </div>
                        </div>
                      </div>
                        ...
                        {trackingSteps.map((step, i) => (
                          <div key={i} className={`flex md:flex-col items-center gap-4 md:gap-6 relative z-10 ${!step.active ? 'opacity-30' : ''}`}>
                            ...
                            <div className="flex flex-col md:items-center md:text-center gap-1">
                              <span className="font-black text-xs text-black tracking-tighter">{step.status}</span>
                      ...
                      <div className="bg-gray-50 border border-gray-100 rounded-[48px] p-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex flex-col gap-2">
                          <h4 className="text-2xl font-black text-black">Need a custom update?</h4>
                          <p className="text-gray-500 font-medium">Connect with our logistics concierge for precise orchestration.</p>
                        </div>
                        <Button variant="ghost" className="text-black border-gray-200 px-10 rounded-2xl h-14 font-black tracking-widest text-sm">
                          Request Detail
                        </Button>
                      </div>
                    </motion.div>
